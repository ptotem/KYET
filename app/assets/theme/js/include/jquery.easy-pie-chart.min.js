(function () {
    (function ($) {
        ...
        $.easyPieChart.defaultOptions = {barColor:"#ef1e25", trackColor:"#c0c0c0", scaleColor:"#dfe0e0", lineCap:"round", size:110, lineWidth:3, animate:false, onStart:$.noop, onStop:$.noop};
